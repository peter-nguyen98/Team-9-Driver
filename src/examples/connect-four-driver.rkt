...
(define exe-2 "/usr/local/bin/racket")
(define args-2 '("connect-four-scoring.rkt"))

;(define exe-2 "/usr/local/bin/racket")
;(define args-2 '("connect-four-scoring-2.rkt"))

; These don't seem to be working now. It might be a dependency issue?
; These aren't integral to continuing, so I won't worry about it.

;(define exe-2 "/Applications/Julia-1.1.app/Contents/Resources/julia/bin/julia")
;(define args-2 '("connect-four-naive.jl"))

;(define exe-2 "/usr/local/bin/python")
